Rails.application.routes.draw do
  ...
  resources :manufacturers, only: [:index, :show, :new, :create, :edit, :update] #o only filtras as ações disponíveis
  ...
  resources :subsidiaries, only: [:index, :show, :new, :create, :edit]
